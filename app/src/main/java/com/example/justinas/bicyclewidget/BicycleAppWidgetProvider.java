...
public class BicycleAppWidgetProvider extends AppWidgetProvider {
    ...
    public void onUpdate(Context context, AppWidgetManager appWidgetManager, int[] appWidgetIds) {
        Log.i("BicycleAppWidetPRovicer", "onUpdate");
    ...
    public void onAppWidgetOptionsChanged(Context context, AppWidgetManager appWidgetManager, int appWidgetId, Bundle newOptions) {
        int[] ids = new int[1];
        ids[0] = appWidgetId;
        //new DownloadStationsTask(context, appWidgetManager, ids).execute();
        Log.i("BicycleAppWidetPRovicer", "onAppWidgetOptionsChanged");
    }
    @Override
    public void onEnabled(Context context) {
        Log.i("BicycleAppWidetPRovicer", "onEnabled");
    }

    public void onRestored(Context context, int[] oldWidgetIds, int[] newWidgetIds) {
        Log.i("BicycleAppWidetPRovicer", "onRestored");
    }
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if(action == WIDGET_UPDATE_ACTION){
            ...
            setListAdapter(widgetId, context, appWidgetManager);
     /*       int[] ids = new int[1];
            ids[0] = widgetId;
            new DownloadStationsTask(context, appWidgetManager, ids).execute();*/
        }
...
Log.i("setListAdapter", "updated widget "+appWidgetId);
    ...
    private void setRefreshHandler(Context context, int appWidgetId, AppWidgetManager appWidgetManager) {
        ...
        views.setOnClickPendingIntent(R.id.configureButton, pendingIntent);
        appWidgetManager.updateAppWidget(appWidgetId, views);
    }
